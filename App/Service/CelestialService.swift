...
class CelestialService {
    ...
    private typealias Events = PlanetEvents
...
//            timezone: timezone,
    ...
    func fetchLocations(
        ...
        by component: Calendar.Component = .hour) -> [PlanetEvents.Location] {
        ...
        return (0...stepCount).compactMap { step -> PlanetEvents.Location? in
