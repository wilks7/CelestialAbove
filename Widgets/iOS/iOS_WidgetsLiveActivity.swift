...
struct iOS_WidgetsLiveActivity_Previews: PreviewProvider {
    static let attributes = iOS_WidgetsAttributes(name: "Me")
    static let contentState = iOS_WidgetsAttributes.ContentState(value: 3)
